 ...
 * All rights reserved.
 *
 * Minimal register-level ADAU1777 driver for the AMAUD1 loopback demo.
 *
 * Register addresses and configuration values are based on the publicly
 * available Analog Devices ADAU1777 documentation.
 *
 * This file is project-authored and is not part of the AmbiqSuite SDK
 * or an Analog Devices software package.
 */
 ...
 * ADAU1777 is the I2S clock master and generates BCLK and LRCLK/WS.
 * Apollo510B operates as the I2S clock slave.
 */
#define ADAU1777_SAI0_I2S_STEREO_24KHZ            0x04U
#define ADAU1777_SAI1_MASTER_32BCLK               0x01U
...
uint32_t adau1777_init(void)
{
    ...
    /* ADAU1777 is the clock master; Apollo510B is the 24 kHz I2S slave. */
